...
class PreferabliForWooCommerceFeedHandler
{
    public function getFeedDataArray( $limit = 100, $offset = 0 ) {
        ...
        if  ( array_key_exists("api_feed_category_ids", $p4wc_options) && strlen($p4wc_options["api_feed_category_ids"])>0) {
            $api_feed_categories_string = $p4wc_options["api_feed_category_ids"];
        ...
        if  ( array_key_exists("api_feed_custom_field_slugs", $p4wc_options) && strlen($p4wc_options["api_feed_custom_field_slugs"])>0) {
            $api_feed_custom_fields_slugs_string = $p4wc_options["api_feed_custom_field_slugs"];
